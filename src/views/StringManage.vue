<template>
  <div class="string-page">
    <a-card class="string-card" :bordered="false">
      <div class="ruben-toolbar">
        ...
        <div class="toolbar-right">
          <a-button class="btn-light" @click="onBatchBind">
            <template #icon>
              <LinkOutlined />
            </template>
            批量绑定
          </a-button>
          <a-button class="btn-light" @click="onQuickEdit">
            快速编辑
          </a-button>
          <a-button type="primary" class="btn-primary-strong" @click="onVisualModel">
            可视化建模
          </a-button>
        </div>
      </div>
...
import { EditOutlined, LeftOutlined, LinkOutlined, RightOutlined } from '@ant-design/icons-vue'
